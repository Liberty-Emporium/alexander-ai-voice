 ...
 *
 * Browser limitation: we can only capture keys while Alexander AI Voice has key
...
export function ChordPicker({
  ...
  // Wire global listeners only while open. Capture phase so Alexander AI Voice's
