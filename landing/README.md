# Alexander AI Voice Landing Page

Landing page for alexanderaivoice.com - a modern Next.js 16 application.
...
5. Configure custom domain `alexanderaivoice.com` in Railway settings
