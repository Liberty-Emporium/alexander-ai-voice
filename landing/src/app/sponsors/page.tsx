    ...
    <>
      ...
      <section className="relative pt-32 pb-16">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          >
            Alexander AI Voice is the open-source AI voice studio used by creators, podcasters, voice
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Stat
              ...
              note="alexanderaivoice.com, last 30 days · growing 5×"
            />
            <Stat
              value="Millions"
              label="Social reach"
          ...
          <p className="text-center text-sm text-muted-foreground mt-10 max-w-2xl mx-auto">
            Alexander AI Voice users are content creators, podcasters, voice artists, writers, developers,
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="rounded-2xl border-2 border-accent/40 bg-card/60 backdrop-blur-sm p-8 mb-4 shadow-[0_8px_40px_hsl(43_60%_50%/0.08)]">
            ...
            <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-foreground mb-2">
              alexanderaivoice.com — directly below the hero.
            </h3>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <Perk
              title="Release notes"
              body="One-line acknowledgement in the next major release post — read by the long tail of users who follow Alexander AI Voice updates."
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="rounded-2xl border-2 border-accent/40 bg-card/60 backdrop-blur-sm p-8 md:p-10 shadow-[0_8px_40px_hsl(43_60%_50%/0.1)]">
            ...
            <ul className="space-y-3 mb-8">
              <PerkRow text="Logo on alexanderaivoice.com — directly below the hero" />
        ...
        <div className="mx-auto max-w-4xl px-6 grid md:grid-cols-2 gap-4">
          <div className="rounded-xl border border-border bg-card/40 backdrop-blur-sm p-6">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground mb-4">
              Individual supporters keep Alexander AI Voice running too. Drop a tip on Buy Me a Coffee and
          ...
          <div className="rounded-xl border border-border bg-card/40 backdrop-blur-sm p-6">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Alexander AI Voice is local-first and privacy-first. We don't accept sponsorships from
