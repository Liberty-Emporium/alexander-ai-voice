...
2. Email security details to: [security@alexanderaivoice.com](mailto:security@alexanderaivoice.com)
3. Include:
...
- **Keep Alexander AI Voice updated** - Updates include security patches
...
Alexander AI Voice processes all audio locally by default. Your voice data never leaves your machine unless you explicitly enable remote server mode.
...
Thank you for helping keep Alexander AI Voice secure! 🔒
