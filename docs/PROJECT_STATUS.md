# Alexander AI Voice Project Status & Roadmap
...
- Alexander AI Voice's user base skews Apple Silicon (MLX is a primary backend). Shipping a CUDA-only model sets a precedent worth a separate scoping discussion (see issues #419 engine sprawl, #420 platform tiers, PR #465).
...
| Audio playback / session | **#41** (macOS: Alexander AI Voice goes silent after another app takes audio output; restart restores it) — see deep-dive below |
