...
description: "Alexander AI Voice documentation development guide"
---

This directory contains the documentation for Alexander AI Voice, built with [Fumadocs](https://fumadocs.dev).
